...
<!-- ==================== TOP MENU ==================== -->
							...
							<div class="control-group">
								...
								<div class="controls">
									<select id="selectedRecord" name="selectedRecord"
										onchange="findPointage(this.value)">
								...
								<br> <label class="control-label">Absence non régularisée : </label>
								<div class="controls">
									<select id="selectedPointqge" name="idt"></select>
								</div>
	...
	<script>
		...
		function findPointage(idEnseig) {
			$
					.ajax(
							{
								url : "http://localhost:8080/PrjIsetWeb/WS/GestionPointage/findPointageByEnseig/"
										+idEnseig
							}).then(
							function(data) {
								
								$('#selectedPointqge').empty();
								for (var i = 0; i < data.length; i++) {
									if(data[i].enseignement!=null){
									$('#selectedPointqge').append(
											$("<option></option>").attr(
													"value",
													data[i].idPointage)
													.text("Séance du "+data[i].enseignement.jour.nomJour+" "+data[i].enseignement.seance.nomSeance+" : "+data[i].enseignement.mat.nom_matiere+" "+data[i].enseignement.niveaux.nom_niveau));
								
									}
									else
										if(data[i].ratrappage!=null){
											$('#selectedPointqge').append(
													$("<option></option>").attr(
															"value",
															data[i].idPointage)
															.text("Ratrappage du "+data[i].ratrappage.dateRattrapage+" : "+data[i].ratrappage.enseignement.mat.nom_matiere+" "+data[i].ratrappage.enseignement.niveaux.nom_niveau));
