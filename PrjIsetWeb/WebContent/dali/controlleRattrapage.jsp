					...
					<div class="floatingBox table">
						<div class="container-fluid">
							...
							<table class="tablesorter centerFirstLast" id="membersTable">
								<thead>
									<tr>
										<th data-placeholder="search in usernames...">id</th>
										<th data-placeholder="search in usernames...">idBase</th>
										<th data-placeholder="search in Année...">DateAbs</th>
										<th data-placeholder="search in usernames...">DateRatt</th>
										<th data-placeholder="search in Semestre...">Type</th>
										<th data-placeholder="search in usernames...">codeSalle</th>
										<th data-placeholder="search in Semestre...">codSeance</th>
										<th class="actions">Actions</th>
									</tr>
								</thead>
								<tbody>
									<c:forEach items="${sessionScope.ListeR}" var="emp">
										<tr>
											<td><a href="#" class="username"><c:out
														value="${emp.id}"></c:out></a></td>
											<td><a href="#" class="username"><c:out
														value="${emp.idBase}"></c:out> </a></td>
											<td><a href="#" class="username"><c:out
														value="${emp.dateAbs}"></c:out></a></td>
											<td><a href="#" class="username"><c:out
														value="${emp.dateRatt}"></c:out></a></td>
											<td><a href="#" class="username"><c:out
														value="${emp.type}"></c:out></a></td>
											<td><a href="#" class="username"><c:out
														value="${emp.codeSalle}"></c:out></a></td>
											<td><a href="#" class="username"><c:out
														value="${emp.codSeance}"></c:out></a></td>

											<td><span class="label red"><a
													href="../GestionRattrapage?id=${emp.id}&daliSupp=action"><i
														class="icon-trash delete"></i></a></span></td>
										</tr>
									</c:forEach>
